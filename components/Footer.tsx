...
const footerMessage = {
  twitter: 'https://twitter.com/Transon_Quan',
  github: 'https://github.com/quanscheng',
  telegram: 'https://t.me/TransonQ',
}
